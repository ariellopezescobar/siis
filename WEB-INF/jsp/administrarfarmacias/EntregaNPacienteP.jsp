...
<div style="font-size:15pt"> Entregar Medicamentos al Paciente Programas </div>

<div><a class="volver" href='ListarAtendidosProg.do'>Volver</a></div>
<br>
...
<center>
  <input type="submit" class="siguiente" value='Siguiente' onclick="document.adicionarpaciente.action='<c:url value="/ListaNRecetaP.do"/>'"></td>
</center>
