...
<div><a class="volver" href='ListarAtendidosSPS.do'>Volver</a></div>
<br>
...
<form name="forma" method="POST" action='<c:url value="/ListaNRecetaSPS.do"/>' >
    ...
    <table class="formulario" width="100%">
      ...
      <tr>    
             <td class="etiqueta">Tipo Ley475</td>    
       	     <td class="etiqueta">::</td>
	     <td>                   
                <SELECT NAME="id_programa">
                    <option value="1" selected> Menor de 5 años </option>
                    <option value="2" > Mujer Embarazada </option>
                    <option value="3" > Mujer Edad Fertil </option>     
                    <option value="4" > Mayor 60 años </option>     
...
<center>
  <input type="submit" class="siguiente" value='Siguiente' onclick="document.adicionarpaciente.action='<c:url value="/ListaNRecetaSPS.do"/>'"></td>
</center>
