...
<div style="font-size:15pt"> Entrega de Medicamentos solo SIIS(exSUMI)</div>
<table border="1">
 <tr>
   <td>
    <table>
      <tr>
      <form name=formas method=post action='<c:url value="/ListarAtendidosSPS.do"/>'>
        <td colspan="2">
          <div class="agregar">
          <a href="javascript:document.formas.submit();" >Nuevo Receta Ley475 (exSumi)</a>
...
<div style="font-size:15pt"> Pacientes SIIS que estan Internados</div>
<br>
