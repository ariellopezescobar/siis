...
<form name="forma" method="POST" action='<c:url value="/ReporteResumen.do"/>' >
<center>
  <table class="table table-bordered table-hover table-condensed table-responsive">
    <tr>
      <th><center>RESUMEN GENERAL DE ATENCION DE PACIENTES</center></th>
    </tr>
    <tr>
      <td>
        <fieldset> 
            <table class="table table-borderedtable-condensed table-responsive"> 
              <tr>  
