...
<form name="adicionarvigencia" method="POST" action='<c:url value="/ListarVigenciaAt.do"/>' >
 <center>
  <table class="table table-bordered table-hover table-condensed table-responsive">
    <tr>
      <th colspan="4" bgcolor="#F2F2F2"><center>REPORTE DIARIO DE RIESGOS ESTRAORDINARIOS</center></th>
    </tr>
    <tr>
    ...
    <tr>
       <td align="right" bgcolor="#F2F2F2"> CLASE DE RIESGO:: </td>
       <td bgcolor="blue" colspan="3" ><textarea name="documento" rows="2" cols="60" style="width: 100%" placeholder="Clase o tipo de Riesgo..."></textarea></td>
    </tr>   
    <tr>
...
Calle::<input type="text" name="calle" value="<c:out value="${datopacv.seguro}"/>" maxlength="50" size="30" />
  Nro::<input type="text" name="nropac" value="0" maxlength="10" size="6" /> 
Telefono::<input type="text" name="telefono" value="<c:out value="${datos.telefono}"/>" maxlength="20" size="10" /></td>
  ...
  <center>
    <input type="submit" name='accion' class="btn btn-primary btn-lg" value='GuardarDocumentoR' onclick="document.adicionarvigencia.action='<c:url value="/ListarVigenciaAt.do"/>';">  
  </center>
     <input type="hidden" name='id_reservacion'   value='<c:out value="${id_reservacion}"/>'> 
     <input type="hidden" name='id_persona'       value='<c:out value="${id_persona}"/>'>
     <input type="hidden" name='id_consultorio'   value='<c:out value="${id_consultorio}"/>'>
