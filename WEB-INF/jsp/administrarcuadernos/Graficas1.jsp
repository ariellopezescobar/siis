...
<script type="text/javascript">
        $(function () {
            $('#container').highcharts({
                ...
                title: {
                    text: 'Población de Pacientes  Atendidos'
                },
                tooltip: {
            ...
            series: [{
                ...
                data: [
                    <c:forEach var="calidad" items="${grafica1}" varStatus="contador">
                        ['0 a 5 meses',   <c:out value="${calidad.suma1}"/>],
                        ['6 a 11 meses',   <c:out value="${calidad.suma2}"/>],
                        ['1 a <4 años',   <c:out value="${calidad.suma3}"/>],
                        ['5 a <9 años',   <c:out value="${calidad.suma4}"/>],
                        ['10 a 14 años',   <c:out value="${calidad.suma5}"/>],
                        ['15 a 19 años',   <c:out value="${calidad.suma6}"/>],
                        ['20 a 39 años',   <c:out value="${calidad.suma7}"/>],
                        ['40 a 49 años',   <c:out value="${calidad.suma8}"/>],
                        ['50 a 59 años',   <c:out value="${calidad.suma9}"/>],
                        ['60 y mas años',   <c:out value="${calidad.suma10}"/>]
                     </c:forEach>
            ]
        }]
    });
...
<center>
 ...
 <center>
    ...
    <input type="submit" name="boton" class="btn btn-primary" value="NINOS">
  </center>
</form>
