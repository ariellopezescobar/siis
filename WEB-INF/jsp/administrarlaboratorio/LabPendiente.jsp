 ...
 <form name="f1" method="POST" action='<c:url value="/LabPendiente.do"/>' >
    ...
    <c:if test="${quimicas == 'quimicas' }"> 
     ...
     <c:forEach var="listaquim" items="${listaquim}" varStatus="contador">  
         <c:if test="${listaquim.id_costo=='153' }">    <!--ASTO -->
          <tr style="font-size:10pt"><td  colspan="2"><c:out value="${listaquim.laboratorio}"/></td>        
           <td colspan="2"><input type="text" name="q153" value="<c:out value="${listaquim.resultado}"/>" size=40 maxlength=40 onblur='validar(entrada,"9")'/></td>      
         </tr>
         </c:if>   
       </c:forEach>
     <c:forEach var="listaquim" items="${listaquim}" varStatus="contador">  
     ...
     <c:forEach var="listaquim" items="${listaquim}" varStatus="contador">  
         <c:if test="${listaquim.id_costo=='132' }">    <!--Reaccion Widal -->
           <tr style="font-size:10pt"><td colspan="2"><c:out value="${listaquim.laboratorio}"/></td>        
             <td colspan="2"><input type="text" name="q132" value="<c:out value="${listaquim.resultado}"/>" size=40 maxlength=40 onblur='validar(entrada,"9")'/></td>      
           </tr>
         </c:if>   
       </c:forEach>
  ...
  <c:if test="${serologia == 'serologia' and id_estado=='A' }"> 
      ...
      <tr style="font-size:10pt">    
          ...
          <td ><input type="text" name="q212" value="0" size="15" maxlength="20"></td>
          <td align="right">PSA:</td>
          <td ><input type="text" name="q224" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          <td align="right">Factor Reumatoideo:</td>
          <td ><input type="text" name="q123" value="0" size="15" maxlength="20"></td>
          <td align="right">HELICOBACTER PYLON:</td>
          <td ><input type="text" name="q157" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          <td align="right">Dosificacion HGC:</td>
          <td ><input type="text" name="q225" value="0" size="15" maxlength="20"></td>
      ...
      <tr style="font-size:10pt">    
          ...
          <td ><input type="text" name="q227" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          ...
          <td ><input type="text" name="q228" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          ...
          <td ><input type="text" name="q234" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          <td align="right">Antigeno </td>
          ...
          <td ><input type="text" name="q235" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          <td align="right">V.D.R.L.:</td>
          <td ><input type="text" name="q134" value="0" size="15" maxlength="20"></td>
          <td align="right">TSH:</td>
          <td ><input type="text" name="q237" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          <td align="right">R.P.R.:</td>
          <td ><input type="text" name="q134" value="0" size="15" maxlength="20"></td>
          <td align="right">T4 libre:</td>
          <td ><input type="text" name="q236" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          <td align="right">Prueba Rapida para VIH:</td>
          <td ><input type="text" name="q154" value="0" size="15" maxlength="20"></td>
          <td align="right">ELISA Cisticercosis:</td>
          <td ><input type="text" name="q229" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          <td align="right">HEPATITIS A:</td>
          <td ><input type="text" name="q221" value="0" size="15" maxlength="20"></td>
          <td align="right">PSA:</td>
          <td ><input type="text" name="q224" value="0" size="15" maxlength="20"></td>
      </tr>
      <tr style="font-size:10pt">    
          <td align="right">HEPATITIS B:</td>
          <td ><input type="text" name="q222" value="0" size="15" maxlength="20"></td>
          <td align="right">HEPATITIS C:</td>
          <td ><input type="text" name="q223" value="0" size="15" maxlength="20"></td>
      </tr>
  </c:if>    
